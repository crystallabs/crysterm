      ...
      class HeaderBar < Widget::Layout
        ...
        def initialize(
          ...
          **layout,
          ...
          @title = Widget::Box.new height: h, align: :vcenter, style: @style_pl2, width: 16, content: title_content
          @section = Widget::Box.new height: h, align: :vcenter, style: @style, width: "50%-16", content: section_content
          @subsection = Widget::Box.new height: h, align: :vcenter, style: @style, width: "50%-16", content: subsection_content
          @info = Widget::Box.new height: h, align: {:vcenter, :right}, style: @style_pr2, width: 16, content: info_content
