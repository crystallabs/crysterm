...
#        #debug : Bool = false,
#        #dump : Bool = false,
#        #terminal : String = ::Crysterm::Helpers.find_terminal,
#        #force_unicode = false,
#        @title : String? = nil,
#        #@artificial_cursor = false,
#        #@cursor_shape = :block,
#        #@cursor_blink = false,
#        #@cursor_color : String? = nil,
#        resize_timeout = 2,
#        #rsety,
#        #listen,
#        focused = nil
#      )
#
#        # TODO Why this is being set unconditionally?
#        #@program.setup_tput
#        #@program.buffer = true
#        #@program.zero = true
#        #@program.resize_timeout = resize_timeout
#
#        super()
#
#
#        #@_unicode = @program.tput.unicode || ::Crysterm::Tput::Numbers.U8 == 1
#        #@full_unicode = @options.full_unicode && @_unicode
#
#        @renders = 0
#
#        @position = {
#          left: @left = @aleft = @rleft = 0,
#          right: @right = @aright = @rright = 0,
#          top: @top = @atop = @rtop = 0,
#          bottom: @bottom = @abottom = @rbottom = 0,
#          # TODO
#          #height / width
#        }
#
...
#        bind
#
#        # TODO activate, turn into a class or record
#        # Then make cursor: be accepted function argument
#        #@cursor = {
#        #  artificial: artificial_cursor,
#        #  shape: cursor_shape,
#        #  blink: cursor_blink,
#        #  color: cursor_color,
#        #  _set: false,
...
#        #}
#
##        # TODO Need type safety without not_nil!?
##        p = @program.not_nil!
##
##
##        p.on(FocusEvent) { emit FocusEvent }
##        p.on(BlurEvent) { emit BlurEvent }
##        p.on(WarningEvent) { |text| emit WarningEvent, text }
##
##        p.on(NewListenerEvent) { |type|
##          # TODO
##          # Also, some duplicate events here like 'mouse'?
...
#      end
#
#      def title() @program.title end
#      def title=(arg) @program.title= arg end
#
#      def term() @program.term end
#      def term=(arg) set_term(arg); @program.term end
#      def set_term(arg)
#        entered = @program.is_alt # XXX !!program.is_alt ?
#        if entered
#          @_buf = ""
#          @program._buf = ""
#          leave
...
#      end
#
#      def height() @program.rows end
#      def width() @program.cols end
#    end
#  end
#end

## requires program, node, element, log, box
#
#    #  @resize_timeout = 0
#    #  @force_unicode = true
#    #  # @program : Program TODO enable when Program class implemented
#    #  @resize_timeout = 0
#    #  @tab_size = 4
#    #  @dock_borders = true
#    #  @ignore_locked = [] of String # of Node?
#    #  @full_unicode = true
#    #  @artificial_cursor = false
#    #  @cursor_blink = false
#    #  @cursor_shape = " "
#    #  @cursor_color = ""
#    #  #@cursor = {} of Symbol => Strg
#
#    #  @left = 0
#    #  @right = 0
#    #  @top = 0
