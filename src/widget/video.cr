...
module Crysterm
  class Widget
    ...
    # animation frames, and one of the existing `Widget::Media` backends renders
    # them like an animated GIF. `Video.new` is a thin factory returning the
