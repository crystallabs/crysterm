...
CT::WidgetExample.run "Manual" do |window|
  ...
  container = CW::Box.new \
    ...
    layout: CT::Layout::Manual.new
  CW::Box.new parent: container, top: 1, left: 2, width: 24, height: 4,
    content: "{center}(left: 2, top: 1){/center}", parse_tags: true
  CW::Box.new parent: container, top: 7, left: 28, width: 26, height: 5,
    content: "{center}(left: 28, top: 7){/center}", parse_tags: true
  CW::Box.new parent: container, bottom: 1, right: 2, width: 22, height: 4,
