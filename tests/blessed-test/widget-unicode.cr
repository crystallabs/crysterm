...
s = CT::Window.new full_unicode: true
...
CW::Box.new(
  ...
  style: CT::Style.new(bg: "#202020", fg: "#ffffff"),
)
...
CW::Box.new(
  ...
  style: CT::Style.new(border: true, fg: "#80d0ff"),
)
...
CW::Box.new(
  ...
  style: CT::Style.new(border: true, fg: "#ffd080"),
)
...
CW::Box.new(
  ...
  style: CT::Style.new(border: true, fg: "#a0ffa0"),
)
...
CW::Box.new(
  ...
  content: "😀 😃 😄 😁 😆 😅 😂 🤣 😉 😊\n" \
           ...
           "👍 👎 👏 🙏 🎉 🚀 ❤️ 🔥 ✨ ⭐",
  align: Tput::AlignFlag::Center,
  style: CT::Style.new(border: true, fg: "#ffd0e0"),
)
