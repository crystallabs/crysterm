...
Crysterm::WidgetExample.run "Map" do |screen|
  screen.stylesheet = "Map { border: solid; }"
  map = Crysterm::Widget::Graph::Map.new parent: screen, top: 0, left: 0, width: "100%", height: "100%"
