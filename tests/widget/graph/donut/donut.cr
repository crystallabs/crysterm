...
# Run it:     crystal run tests/widget/graph/donut/donut.cr
require "../../example"
...
Crysterm::WidgetExample.run("Donut",
  script: ->(d : Crysterm::WidgetExample::Driver) {
    ...
    [65, 75, 85, 95, 85, 75, 65].each do |v|
      d.act(dwell: 0.4) { |s| s.children.each { |c| c.value = v if c.is_a?(CW::GraphDonut) } }
    end
  }) do |window|
  ...
  CW::GraphDonut.new parent: window, top: "center", left: "center", width: 24, height: 12, value: 65
end
