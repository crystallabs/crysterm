...
Crysterm::WidgetExample.run("PlainTextEdit",
  ...
  screen.stylesheet = "PlainTextEdit { border: solid; color: #c0caf5; background-color: #1f2335; }"
  ta = Crysterm::Widget::PlainTextEdit.new parent: screen, top: "center", left: "center", width: 46, height: 9
