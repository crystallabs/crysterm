...
s = CT::Window.new title: "Styling 5"
...
boxes = [
  ...
  {"look: :raised\n(outset shade)",
   CT::Style.new(border: CT::Border.new(fg: "#9fc7ff"), look: :raised)},
  {"look: :sunken\n(inset shade)",
   CT::Style.new(border: CT::Border.new(fg: "#5fe0c0"), look: :sunken)},
  {"look: :beveled\n(weight bevel)",
   CT::Style.new(border: CT::Border.new(type: :dotted, fg: "#d090ff"), look: :beveled)},
  {"look: :chiseled\n(inset weight)",
   CT::Style.new(border: CT::Border.new(type: :dotted, fg: "#90e070"), look: :chiseled)},
  # Row 2: auto-placed shadows under different lights.
  {"shadow: true\n(scene light NW)",
   CT::Style.new(border: true, shadow: true)},
  {"light: :n\n(exact silhouette)",
   CT::Style.new(border: true, shadow: true, light: :n)},
  {"light: n spot\n(band spills 1)",
   CT::Style.new(border: true, shadow: true, light: CT::Light.new(:n, :spot))},
  {"light: :se\n(shadow flips)",
   CT::Style.new(border: true, shadow: true, light: :se)},
  # Row 3: composites and the weight rendition on the other media.
  {"look: :elevated\n(raised+shadow)",
   CT::Style.new(border: CT::Border.new(fg: "#7fb2e8"), look: :elevated)},
  {"look: :floating\n(thin shadow)",
   CT::Style.new(border: CT::Border.new(type: :rounded, fg: "#b0d878"), look: :floating)},
  {"beveled + :se\n(bevel follows)",
   CT::Style.new(border: CT::Border.new(type: :dotted, fg: "#e888ac"), look: :beveled, light: :se)},
  {"braille weight\n(lit +1 dot-line)",
   CT::Style.new(border: CT::Border.new(type: :braille, fg: "#78d8c4",
