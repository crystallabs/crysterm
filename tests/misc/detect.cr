...
# twice: once pinned to universal braille glyphs, once to Kitty pixel
# graphics (the pixel ring shows on Kitty-capable terminals and in the PNG
# shot). The lower panel lists what detection found on THIS terminal, and
...
braille = GraphDonut.new parent: s, top: 2, left: 4, width: 30, height: 13,
...
kitty = GraphDonut.new parent: s, top: 2, left: 46, width: 30, height: 13,
