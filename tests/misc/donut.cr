...
s = CT::Window.new title: "Donut + GaugeList"

# Mode 1 (default): only the filled arc is drawn — the remainder stays empty.
cpu = CW::GraphDonut.new parent: s, top: 0, left: 0, width: 20, height: 11,
  value: 0, label: "CPU", fill_color: 0x40E0D0, style: CT::Style.new(fg: "white", bg: "#101820", border: true)
# Mode 2 (show_track): the full ring shows in the track color, value arc on top.
mem = CW::GraphDonut.new parent: s, top: 0, left: 21, width: 20, height: 11,
...
gl = CW::GaugeList.new parent: s, top: 0, left: 42, width: 34, height: 11,
  style: CT::Style.new(fg: "white", bg: "#101820", border: true)
...
CW::FPS.new parent: s, top: "100%-1", left: 0,
  format: "FPS %5s  (R %5s / D %5s)", args: [CW::FPS::Metric::Fps, CW::FPS::Metric::Render, CW::FPS::Metric::Draw],
  style: CT::Style.new(fg: "black", bg: 0x40e0c0)
