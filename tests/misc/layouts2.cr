...
s = CT::Window.new title: "Layout engines 2"
...
p1.layout = CT::Layout::Box.new justify: :space_between, align: :center
...
p3.layout = CT::Layout::Masonry.new
...
p4.layout = CT::Layout::UniformGrid.new
...
p6.layout = CT::Layout::Radial.new
