...
# on empty content: empty content leaves `@wrapped_lines.fake` empty, and Crystal's
...
describe "Widget#line on empty content" do
  ...
  it "returns a blank line after content is cleared to empty" do
    box = Widget::Box.new parent: headless_screen(default_quit_keys: true), content: "hello"
    box.set_content ""
    box.line(0).should eq ""
  end
