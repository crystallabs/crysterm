...
# it must be ignored, leaving any previously-cascaded size intact rather than
# falling through to the `Cover` default. The sibling `background-image`
# longhand already guards this case; size must too.
