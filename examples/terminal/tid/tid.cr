...
if verbose
  ...
  section.call "CRYSTERM (rendering — derived on top of Tput)", [
    ...
    {"cell_aspect_ratio", Crysterm::CSS::Length.cell_aspect_ratio.to_s,
     Crysterm::CSS::Length.cell_aspect_ratio_configured? ? "pinned (css.cell_aspect_ratio)" : "derived from cell_pixels (default 2.0)"},
