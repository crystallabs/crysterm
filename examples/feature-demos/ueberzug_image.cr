...
#
# `Widget::UeberzugImage` is the modern successor to the w3mimgdisplay overlay:
...
s = Screen.new title: "UeberzugImage"
s.show_fps = nil

Widget::Box.new \
  parent: s, top: 0, left: 0, width: "100%", height: 1,
  content: "{center}UeberzugImage  ·  überzug X11 overlay (w3m successor)  ·  the Matterhorn{/center}",
  parse_tags: true, style: Style.new(fg: "white", bg: "#202830")

unless Widget::UeberzugImage.binary
  Widget::Box.new \
