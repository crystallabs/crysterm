...
#
# `Widget::ItermImage` base64-encodes the *original* PNG file and sends it in
...
s = Screen.new title: "ItermImage"
s.show_fps = nil

Widget::Box.new \
  parent: s, top: 0, left: 0, width: "100%", height: 1,
  content: "{center}ItermImage  ·  iTerm2 inline-images protocol (OSC 1337)  ·  the Matterhorn{/center}",
  parse_tags: true, style: Style.new(fg: "white", bg: "#202830")

iw = s.awidth
ih = s.aheight - 1

Widget::ItermImage.new \
