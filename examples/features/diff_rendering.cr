...
Widget::Box.new \
  ...
  content: "{center}Diff-based drawing — only changed cells are redrawn (see R/D/FPS below){/center}",
  parse_tags: true,
  style: Style.new(fg: "white", bg: "#202830")

# A large, static, decorated background area.
Widget::Box.new \
  parent: s, top: 2, left: 0, width: 60, height: 9,
...
ticker = Widget::Box.new \
  parent: s, top: 2, left: 61, width: 17, height: 9, align: :hcenter,
