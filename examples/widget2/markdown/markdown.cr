...
Crysterm::WidgetExample.run "Markdown" do |screen|
  screen.stylesheet = "Markdown { border: solid; }"
  md = Crysterm::Widget::Markdown.new parent: screen, top: "center", left: "center", width: 52, height: 14
